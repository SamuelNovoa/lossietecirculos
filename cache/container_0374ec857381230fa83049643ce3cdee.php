...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('mysql.hostinger.es', 'u355358646_admin', 't5#0xavLOU', 'u355358646_forum', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => 'mysql.hostinger.es',
            'dbal.dbuser' => 'u355358646_admin',
            'dbal.dbpasswd' => 't5#0xavLOU',
            'dbal.dbname' => 'u355358646_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
